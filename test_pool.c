...
UTEST(pool, creation) {
    ...
    ASSERT_EQ(pool.cap_chunks, (size_t)4);
    ASSERT_EQ(pool.used_chunks, (size_t)0);
}
...
UTEST(pool, alloc) {
    ...
    ASSERT_EQ(pool.used_chunks, (size_t)1);
    ASSERT_EQ(pool.top, (pool_chunk*)(wa_t*)(wa + 8));
}
...
UTEST(pool, multiple_alloc) {
    ...
    ASSERT_EQ(pool.used_chunks, (size_t)2);
